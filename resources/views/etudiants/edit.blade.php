...
<html lang="en">
  ...
  <body class="bg-gray-100 p-6">
    ...
    <form action="{{ route('etudiant.update', ['etudiant' => $etudiant]) }}" method="POST" autocomplete="off"
      ...
      <div class="mb-4">
        ...
        <input type="text" id="nom" name="nom" placeholder="Nom..." value="{{ $etudiant->nom }}"
          class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500">
      </div>
      <div class="mb-4">
        <label for="prenom" class="block text-gray-700 text-sm font-bold mb-2">Prénom :</label>
        <input type="text" id="prenom" name="prenom" placeholder="Prénom..." value="{{ $etudiant->prenom }}"
          class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500">
      </div>
      <div class="mb-6">
        <label for="cin" class="block text-gray-700 text-sm font-bold mb-2">CIN :</label>
        <input type="text" id="cin" name="cin" placeholder="CIN..." value="{{ $etudiant->cin }}"
          class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500">
      </div>
      <button type="submit"
